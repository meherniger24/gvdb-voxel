...
int main (int argc, char* argv)
{
	...
	// Load VDB
	char scnpath[1024];		
	if ( !gvdb.getScene()->FindFile ( "dragon_levelset.vdb", scnpath ) ) {
	...
	gvdb.SaveVBX ( "dragon_levelset.vbx" );						// Save VBX format
	...
	save_png ( "utahteapot.png", buf, w, h, 4 );		// Save image as png
